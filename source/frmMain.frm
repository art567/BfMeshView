...
Begin VB.Form frmMain 
   ...
   Begin VB.Menu mnuView 
      ...
      Begin VB.Menu mnuViewTexture 
         ...
         Checked         =   -1  'True
      End
      Begin VB.Menu mnuViewBumpMap 
         Caption         =   "Bump Map"
         Checked         =   -1  'True
      End
      Begin VB.Menu mnuViewEnvmap 
   ...
   Begin VB.Menu mnuTools 
      ...
      End
      Begin VB.Menu mnuToolsReloadShaders 
         Caption         =   "Reload Shaders"
      End
   ...
   Begin VB.Menu mnuTreeContext 
      ...
      Begin VB.Menu mnu 
         Caption         =   "-"
      End
      Begin VB.Menu mnuTreeContextDelete 
         Caption         =   "Delete"
      End
...
Public Sub picMain_Paint()
    ...
    If sel_vis Then
        ...
        glLoadIdentity
        glOrtho 0, viewport_w, viewport_h, 0, -1, 1
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    Select Case KeyCode
    Case vbKeyControl: keyctrl = False
    Case vbKeyMenu:    keyalt = False
    Case vbKeyShift:   keyshift = False
    End Select
End Sub
...
Private Sub picTime_Paint()
    ...
    If wt > 0 Then
        ...
        DrawRect picTime.hDC, 1, 1, wt + 1, h - 1
...
Private Sub mnuViewBumpMap_Click()
    view_bumpmap = Not view_bumpmap
    mnuViewBumpMap.Checked = view_bumpmap
    picMain_Paint
End Sub

Private Sub mnuViewEnvmap_Click()
    view_envmap = Not view_envmap
    mnuViewEnvmap.Checked = view_envmap
    picMain_Paint
End Sub
...
Private Sub mnuToolsReloadShaders_Click()
    ReloadShaders
    picMain_Paint
End Sub
...
Private Sub mnuTreeContextDelete_Click()
    If ValSel(3) Then
        BF2DeleteMat selgeom, sellod, selmat
    Else
        If ValSel(2) Then
            BF2DeleteLod selgeom, sellod
        End If
    End If
End Sub
